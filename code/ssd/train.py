...
#         print(a.dtype,a.device)
    ...
    print("torch.cuda.is_not_available")
    torch.set_default_tensor_type('torch.FloatTensor')
...
#         loc_loss += loss_l(reduction="sum").item()
#         conf_loss += loss_c(reduction="sum").item()
        ...
        if iteration != 0 and iteration % 500 == 0:
            ...
            torch.save(ssd_net.state_dict(), './weights/AC_' +
                       repr(iteration) + '.pth')
        
#         if iteration % 100 == 0:
#             fname.append(loss.data.item())
#     np.savetxt('./fname.txt',fname)
